module github.com/openabstractions/addon-synology/spk/app

go 1.26.0

require (
	github.com/openabstractions/abstraction-download/go v0.4.1
	github.com/openabstractions/abstraction-facade/go v0.4.0
...
require (
	...
	github.com/openabstractions/abstraction-logging/go v0.3.0 // indirect
